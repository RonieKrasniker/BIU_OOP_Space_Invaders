...
/**
 * Simple test class to validate the core Space Invaders components work
 * correctly.
 */
public class TestSpaceInvaders {
    /**
     * Entry point for simple component tests.
     *
     * @param args CLI args
     */
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle created: (" + rect.getX()
                + ", "
                + rect.getY() + ") "
                + rect.getWidth()
                + "x"
